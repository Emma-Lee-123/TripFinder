...
const startTime = formatTime(params.startTime);
    ...
    const func_url = func_url_base + '?from=' + encodeURIComponent(params.fromId) + '&to=' + encodeURIComponent(params.toId) + '&date=' + encodeURIComponent(date) + '&startTime=' + encodeURIComponent(startTime) + '&transportType=' + encodeURIComponent(params.transportType);
